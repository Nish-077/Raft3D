...
TEST_CASE("RaftKVLogStore basic operations", "[RaftKVLogStore]")
{
    ...
    SECTION("pack and apply_pack")
    {
        ...
        RaftKVLogStore store2(rocksdb2.db, rocksdb2.log_cf, logger2);
