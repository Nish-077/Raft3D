...
namespace Raft3D
{
    ...
    public:
        RaftKVStateManager(int _server_id, std::shared_ptr<rocksdb::DB> rocksdb_instance, std::shared_ptr<rocksdb::ColumnFamilyHandle> log_column_family_handle, const std::vector<Raft3DServer> &initial_peers, std::shared_ptr<Raft3DLogger> logger);
