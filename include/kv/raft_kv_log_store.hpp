...
namespace Raft3D
{
    ...
    public:
        RaftKVLogStore(std::shared_ptr<rocksdb::DB> rocksdb_instance, std::shared_ptr<rocksdb::ColumnFamilyHandle> log_column_family_handle, std::shared_ptr<Raft3DLogger> logger);
